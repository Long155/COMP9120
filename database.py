...
def openConnection():
    ...
    try:
        ...
        #                             password=passwd,
        #                             host=myHost)
        conn = psycopg2.connect(database=database, user=userid, password=passwd, host=myHost, port=myPort) #local

    except psycopg2.Error as sqle:
        error_message = sqle.pgerror if sqle.pgerror else "Unknown error"
        print("psycopg2.Error : " + error_message)
